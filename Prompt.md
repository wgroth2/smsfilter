...
1. **Phase 1 — Project Scaffolding & Build Configuration**
   ...
   - Generate `build.gradle.kts` (root & app module), `settings.gradle.kts`, `proguard-rules.pro`, and `AndroidManifest.xml` (permissions, receiver, and service declarations — these are forward declarations for classes generated in later phases).
